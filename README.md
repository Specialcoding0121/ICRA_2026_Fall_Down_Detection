...
The experiments were conducted in a controlled bathroom mock-up equipped with tiled walls, a glass partition, and a running shower set at 36 °C to replicate wet and cluttered conditions. The floor was kept consistently wet throughout all sessions. We designed nine scenarios covering both non-fall and fall activities: an empty baseline, light and heavy object drops, normal and bent-posture walking, wall-supported walking, static standing, squatting, and intentional falls under expert supervision. Each trial lasted 20–120 seconds, depending on the activity type, and was repeated multiple times to ensure sufficient variability. All radar and vibration recordings were carefully synchronized, and frame-level annotations were generated by aligning vibration energy peaks with radar motion cues. In total, the protocol produced more than 9 hours of multimodal data with over 110,000 radar frames and 3.1 million vibration samples, providing a rigorous benchmark for privacy-preserving fall detection in bathroom environments.
>>>>>>> eb5adc9a77e38d4c1f3c719f694890b495d4489c
